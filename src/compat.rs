    ...
    vec![
        (
            ...
            vec![
                ...
                CompatEntry::new(r"\h",      CompatStatus::Partial,     "SQL syntax help (limited topics)"),
        ...
        (
            ...
            vec![
                ...
                CompatEntry::new(r"\prompt", CompatStatus::Full,        "prompt user for variable value"),
            ],
        ),
        (
            "Describe",
            vec![
                CompatEntry::new(r"\d",   CompatStatus::Full,        "describe object or list relations"),
                ...
                CompatEntry::new(r"\dF",  CompatStatus::Unsupported, "list text search configurations"),
                CompatEntry::new(r"\dL",  CompatStatus::Unsupported, "list procedural languages"),
                ...
                CompatEntry::new(r"\sf",  CompatStatus::Partial,     "show function source (read-only)"),
                CompatEntry::new(r"\sv",  CompatStatus::Partial,     "show view definition (read-only)"),
            ],
        ),
        (
            "Display",
            vec![
                ...
                CompatEntry::new(r"\pset", CompatStatus::Partial,     "set print option (most options)"),
                ...
                CompatEntry::new(r"\T",    CompatStatus::Unsupported, "set HTML table tag attributes"),
        ...
        (
            ...
            vec![
                ...
                CompatEntry::new(r"\ir",          CompatStatus::Full,        "include file relative to script"),
                CompatEntry::new(r"\o",           CompatStatus::Full,        "send output to file or pipe"),
                CompatEntry::new(r"\copy",        CompatStatus::Partial,     "client-side COPY (common options)"),
                ...
                CompatEntry::new(r"\gx",          CompatStatus::Full,        "execute buffer with expanded output"),
                CompatEntry::new(r"\gexec",       CompatStatus::Full,        "execute buffer then execute result cells"),
                CompatEntry::new(r"\gset",        CompatStatus::Full,        "store result columns as variables"),
                CompatEntry::new(r"\gdesc",       CompatStatus::Full,        "describe result columns of buffer"),
                CompatEntry::new(r"\crosstabview",CompatStatus::Full,        "pivot result into cross-tabulation"),
                CompatEntry::new(r"\watch",       CompatStatus::Full,        "re-execute query every N seconds"),
            ],
        ),
        (
            "Connection",
            vec![
                ...
                CompatEntry::new(r"\encoding", CompatStatus::Partial,     "show or set client encoding"),
        ...
        (
            ...
            vec![
                ...
                CompatEntry::new(r"\else",  CompatStatus::Full, "unconditional alternate branch"),
...
pub fn print_compat_report() -> (usize, usize) {
    ...
    println!(
        ...
        cmd_w = cmd_w, status_w = status_w, notes_w = notes_w,
    );
    println!("{separator}");
