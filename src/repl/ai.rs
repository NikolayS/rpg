//! AI command handlers for the REPL (`/ask`, `/fix`, `/explain`, etc.).
//!
//! All functions in this module operate on [`super::ReplSettings`] and the
//! live `tokio_postgres::Client`.  They are called from the input loop via
//! [`dispatch_ai_command`].
...
use super::{
    execute_query, format_system_time, get_ai_provider, ExecMode, InputMode, ReplSettings, TxState,
    YoloWriteAction,
};
