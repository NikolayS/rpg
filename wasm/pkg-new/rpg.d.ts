...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1060: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1379: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1434: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_180: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1435: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2128: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1380: (a: number, b: number, c: number) => void;
