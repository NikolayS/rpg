...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1062: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1381: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1436: (a: number, b: number) => void;
    ...
    readonly __wasm_bindgen_func_elem_1382: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_181: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1063: (a: number, b: number) => void;
