...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2175: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2189: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_186: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1470: (a: number, b: number, c: number) => void;
