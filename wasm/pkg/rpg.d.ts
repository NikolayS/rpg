...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_1383: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1438: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_181: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_1439: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2132: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_1384: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_182: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1065: (a: number, b: number) => void;
