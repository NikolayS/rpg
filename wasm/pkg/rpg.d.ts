...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2113: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2127: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_184: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1408: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_1097: (a: number, b: number) => void;
